    ...
    <ContentLayout pagetitle="">
      <div className="h-full flex flex-col justify-between">
        ...
        <div className="flex flex-col gap-5">
          <Button text="今日の日記を書く" onClick={handleTodaySubmit} css="bg-light-buttonPrimaryDefault hover:bg-light-buttonPrimaryHover" />
          <Button text="昨日の日記を書く" onClick={handleYesterdaySubmit} css="bg-light-buttonPrimaryHover hover:bg-light-buttonPrimaryDefault" />
        </div>
      </div>
    </ContentLayout>
  )
